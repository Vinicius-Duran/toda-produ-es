          ...
          <div className="relative">
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {categories.map((cat, i) => (
                <article
                  key={cat.title}
                  className="reveal group metal-sweep relative overflow-hidden rounded-2xl border border-ink-900/10 bg-ink-900/[0.04] p-7 transition-transform duration-500 hover:-translate-y-1.5"
