...
const ARTIST_FOLDERS = {
  ...
  "andreza-tavares": "Andreza Tavares",
  "arnaldo-quaresma": "Arnaldo Quaresma",
  "augusto-carvalho": "Augusto Carvalho",
  ...
  "sara-rodrigues": "Sara Rodrigues",
  "suellen-brum": "Suellen Brum",
  "yasmin-yanni": "Yasmin Yanni",
  "jamile-dias": "Missionária Jamile Dias",
  "suillan-barreto": "Pregadora Suillan Barreto",
  "rafaela-araujo": "Rafaela Araújo (Pregadora)",
  "fogo-e-gloria": "Fogo e Glória",
};
